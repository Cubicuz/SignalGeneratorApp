...
val selectedSignalType = mutableStateOf("none")
val signalTypes = listOf("none", KickSignal.type, AmpWave.type, FreqWave.type, WaveModFreq.type)
@Composable
fun Content(mva: MoveGameActivity? = null) {
    val fontSize = 20.sp
